      ...
      <main className="mx-auto max-w-3xl px-4 pb-12 space-y-10">
        ...
        <section className="rounded-2xl bg-white border border-slate-200 p-6 shadow-sm">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-red-600 px-4 py-3 text-sm font-semibold text-midnightblue  hover: text-white hover:bg-red-700 transition"
          >
