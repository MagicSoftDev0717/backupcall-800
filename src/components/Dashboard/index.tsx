    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="py-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-soft">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-700 transition"
            >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-soft">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition"
            >
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <Link
            href="/contacts"
            className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-soft hover:shadow-md transition"
          >
