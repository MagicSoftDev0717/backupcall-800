        ...
        <div className="min-h-screen bg-lightblue pt-28 pb-10">
            <main className="py-10 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    {/* Contacts Summary */}
                    <div className="rounded-2xl bg-white p-6 ml-2 mr-2 shadow-soft flex flex-col justify-between">
                ...
                {/* QUICK ACTIONS */}
                <div className="mt-12 grid grid-cols-1 gap-6 ml-2 mr-2 sm:grid-cols-2 lg:grid-cols-3">
                    <Link
                        href="/contacts"
